    ...
    <AppBar position="fixed" color='inherit' >
      <Container maxWidth="xl">
        <Toolbar disableGutters>
          <Avatar src='https://www.zarla.com/images/zarla-p-1x1-2400x2400-20211124-gpwxt6df6qgtc6dfmy6h.png?crop=1:1,smart&width=250&dpr=2' sx={{ display: { xs: 'none', md: 'flex' }, mr: 1 }} />
          <Typography
            variant="h6"
            noWrap
            component="a"
          ...
          <Box sx={{ flexGrow: 0 }}>
            ...
            <Tooltip title="Open settings">
              <IconButton onClick={handleOpenUserMenu} sx={{ p: 0,ml:1 }}>
                <Avatar src={UserLogged?.fotoDePerfil}>{UserLogged && nameInitiais(UserLogged?.nome)}</Avatar>
              </IconButton>
            </Tooltip>
